...
import {makeRequest, run, saveFile, download_file_curl} from './src/utils'
...
if(params.documentId &&  params.designId){
  let documentsUri = `https://api.youmagine.com/v1/designs/${params.designId}/documents/${params.documentId}?auth_token=X5Ax97m1YomoFLxtYTzb`
